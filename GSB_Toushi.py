...
api_id = 17332861          # aqui va el id de tu api
api_hash = '17275e75d4e1a321df12dbf5beb03e2f'		 # aqui el hash de tu api
# fill in your own details here

phone = '+5358356622'  # Cambiarlo
session_file = 'Toushi'  # use your username if unsure

a = 0

Forest , Swamp , Valley , RandomQuest = False , False , False , False

client = TelegramClient('Touishiro', api_id, api_hash,sequential_updates=True)
...
print(time.asctime(), '-', 'Stared Toushiro...')
client.start(phone)
